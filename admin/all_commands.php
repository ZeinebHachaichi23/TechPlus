...
$sql = "SELECT id, user.prenom_u, user.nom_u, total FROM commande JOIN user on user_id = id_u LIMIT $offset, $no_of_records_per_page";
        ...
        <table class="table table-hovered">
            <thead>
                <tr>
                    ...
                    <th style="font-size: 22px;">First Name</th>
                    <th style="font-size: 22px;">Last Name</th>
